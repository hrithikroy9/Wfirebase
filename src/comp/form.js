        ...
        <div className='form'>
            <div className='container'>
                <form method='POST'>
                    ...
                    <p>Number•🍆-<input type='text' name='Number' placeholder='Contact' value={user.Number} maxLength={13} autoComplete='off' required onChange={handleInputChange} /></p>
                    <textarea name='message' placeholder='Enter your feedback' value={user.message} autoComplete='off' required onChange={handleInputChange}></textarea>
